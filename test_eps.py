...
Z_appr_mat_pos = mask * Z_appr_mat

plt.figure(899)
plt.imshow(Z_appr_mat_pos, cmap='gray')
...
Z_appr_mat_neg = mask * Z_appr_mat

plt.figure(999)
plt.imshow(Z_appr_mat_neg, cmap='gray')
...
plt.figure(1000)
plt.imshow(Z_appr_mat_neg-Z_appr_mat_pos, cmap='gray')
